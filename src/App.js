  ...
  render() {
    return (
      <div className="App">
        ...
        <Feature theme="#0e2300" previewImage={takeStairs} video={takeTheStairsVideo} title="Take the Elevator" category="Experimental" description="Ex velit augue voluptua quo, vel modus fuisset ea. Eirmod eripuit molestiae ea duo, duo praesent salutandi scriptorem cu. Lorem omittam repudiandae mea ut, ea sale reque eos. Munere abhorreant usu te, ex per delenit delectus salutatus, summo simul sea an. Fabulas atomorum scriptorem sea ei, stet quando aperiam nam no, congue iriure cum ad."  movieSrc="https://player.vimeo.com/video/148242729"></Feature>
