...
class Feature extends Component {
  ...
  constructor() {
    super();
    this.state = {isOpen: false, featureCenter: 0};
  ...
  handleScroll(e) {
    ...
    if (!this.state.isOpen) {
      ...
      featureCenter = 1 - featureCenter / 1500;
      featureCenter =  Math.min(Math.max(featureCenter, 0.5), 1.5);
      this.setState({featureCenter: featureCenter});
    }
  ...
  render() {
    ...
    let featureStyle = {
      transform: 'scaleX('+ this.state.featureCenter  +')',
      opacity: this.state.featureCenter - 0.2
    }
    ...
    return (
      <div className={activeClass}>
        <div ref="featureBlurb" className="featureContainer">
          <video ref="projectVideo" className="videoElement" style={featureStyle} onClick={this.handleClick} onCanPlay={this.videoCanPlay} src={this.props.video} poster={this.props.previewImage}>
          ...
          <div className="feature" onClick={this.handleClick}>
            ...
            <div className="feature-description" hidden={!this.state.isOpen}>
